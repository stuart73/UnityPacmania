...
namespace Pacmania.GameManagement
{
    public class PlayerGameSession : GameSession
    {
        ...
        public override void GameOver()
        {
            ...
            {
                SceneManager.LoadScene(SceneNames.EnterInitials);
                return;
            }
